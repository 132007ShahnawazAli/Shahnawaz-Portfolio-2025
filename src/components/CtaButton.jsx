...
function CtaButton({ text = "Let's Talk" }) {
  return (
    <div className='w-fit'>
      <div className='w-fit'>
        <Link href={"#contact"} className="group flex flex-row gap-[.6vw] text-[#f8f8ff] md:text-[1vw] text-[3vw] font-semibold md:py-[.7vw] md:px-5 py-2 px-5 rounded-3xl uppercase bg-gradient-to-t from-blue-400 to-blue-500 justify-center items-center mix-blend-hard-light">
          {text} <svg viewBox="0 0 15 17" xmlns="http://www.w3.org/2000/svg" className='md:w-[1vw] w-[2.2vw] h-[2.2vw] md:h-[1vw] transform transition-transform duration-450 ease-in-out group-hover:rotate-[50deg]'>
