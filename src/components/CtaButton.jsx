...
function CtaButton({ text = "Let's Talk" }) {
  return (
    <div>
      <Link href={"#contact"} className="group flex flex-row gap-[.6vw] text-[#f8f8ff] text-[1vw] font-semibold py-2 px-5 rounded-3xl uppercase bg-gradient-to-l from-blue-400 to-blue-500 justify-center items-center mix-blend-hard-light">
